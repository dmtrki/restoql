...
export default function () {
  registerPlugin('gutereca-sidebar', {
    render: () => el(Sidebar)
  })
}
...
class Sidebar extends Component {
   ...
   */
  getElements () {
    const elements = Array.from(document.querySelectorAll(`.gutereca-sidebar *`))
  ...
  render () {
    return (
      <PluginSidebar name="gutereca-sidebar" icon="media-text" title="Gutereca">
        <div className="plugin-sidebar-content gutereca-sidebar-content">
          {this.state.elements}
        </div>
      </PluginSidebar>
    )
