...
use App\Services\GutenbergParser\GutenbergParserBlock;
use App\Services\GutenbergParser\GutenbergParserFrame;
...
class GutenbergParser
{
    ...
    switch ($token_type) {
      ...
      case 'void-block':
        ...
        if (0 === $stack_depth) {
          ...
          $this->output[] = (array) new GutenbergParserBlock($block_name, $attrs, array(), '', array());
        ...
        $this->add_inner_block(
          new GutenbergParserBlock($block_name, $attrs, array(), '', array()),
          $start_offset,
          $token_length
        );
        $this->offset = $start_offset + $token_length;
   ...
   * @return GutenbergParserBlock freeform block object.
   */
  function freeform($innerHTML)
  {
    return new GutenbergParserBlock(null, $this->empty_attrs, array(), $innerHTML, array($innerHTML));
  }
   ...
   * @internal
   * @since 5.0.0
   * @param GutenbergParserBlock $block        The block to add to the output.
   * @param int                   $token_start  Byte offset into the document where the first token for the block starts.
   * @param int                   $token_length Byte length of entire block from start of opening token to end of closing token.
   * @param int|null              $last_offset  Last byte offset into document if continuing form earlier output.
   */
  function add_inner_block(GutenbergParserBlock $block, $token_start, $token_length, $last_offset = null)
  {
