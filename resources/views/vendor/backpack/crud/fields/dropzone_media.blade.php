...
<div class="form-group col-md-12">
	...
	<div id="dropzone_{{ $field['name'] }}" class="dropzone dz-clickable sortable">
	    <div class="dz-message">
	    	{{ __('backpack::dropzone.drop_files_or_click_to_upload') }}
	    </div>
	</div>
</div>
			...
			var dOptions = {
		        ...
		        removedfile: function(file) {
		        	if (typeof file.media != 'undefined') {
						...
						.fail(function (xhr) {
							var message = '{{ __('backpack::dropzone.messages.deletion_failed') }}';
			...
			var dropzone_{{ $field['name'] }}_sortable = new Sortable(document.getElementById("dropzone_{{ $field['name'] }}"), {
	            ...
	            onEnd: function(evt) {
	            	...
	            	if (ids.length > 0) {
						...
						.fail(function (xhr) {
							var message = '{{ __('backpack::dropzone.messages.ordering_failed') }}';
							if (xhr.responseJSON != 'undefined' && xhr.responseJSON.message != 'undefined') {
								message = xhr.responseJSON.message;
							}
							new Noty({
